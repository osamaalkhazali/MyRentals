            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Apartment Details (تفاصيل الشقة) #{{ $apartment->display_name }}</h2>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        <div>
                            <h3 class="text-lg font-semibold mb-4">Basic Information (المعلومات الأساسية)</h3>
                            <dl class="space-y-3">
                                <div class="flex">
                                ...
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Apartment Number (رقم الشقة):</dt>
                                    <dd>{{ $apartment->apartment_number }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Location Text (وصف الموقع):</dt>
                                    <dd>{{ $apartment->location_text }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Location Link (رابط الموقع):</dt>
                                    <dd><a href="{{ $apartment->location_link }}" target="_blank"
                                            class="text-blue-600 dark:text-blue-400 underline">View Map</a></dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Short Label (وصف قصير):</dt>
                                    <dd>{{ $apartment->location ?? 'N/A' }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Floor Number (رقم الطابق):</dt>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold mb-4">Layout & Financials (المخطط والمالية)</h3>
                            <dl class="space-y-3">
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Bedrooms (غرف النوم):</dt>
                                    <dd>{{ $apartment->bedrooms }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Living Rooms (غرف المعيشة):</dt>
                                    <dd>{{ $apartment->living_rooms }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Guest Rooms (غرف الضيوف):</dt>
                                    <dd>{{ $apartment->guest_rooms }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Kitchens (المطابخ):</dt>
                                    <dd>{{ $apartment->kitchens }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Bathrooms (الحمامات):</dt>
                                    <dd>{{ $apartment->bathrooms }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Balconies (الشرفات):</dt>
                                    <dd>{{ $apartment->balconies }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Master Rooms (الغرف الماستر):</dt>
                                    <dd>{{ $apartment->master_rooms }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Square Meters (المساحة):</dt>
                                    <dd>{{ $apartment->square_meters ?? 'N/A' }}</dd>
                                </div>
                                <div class="flex">
                                    <dt class="font-medium w-1/3">Rent Price (الإيجار):</dt>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold mb-4">Description (الوصف)</h3>
                            <p class="text-gray-600 dark:text-gray-400">
                                {{ $apartment->description ?? 'No description available.' }}</p>
                        </div>

                        <div>
                            <h3 class="text-lg font-semibold mb-4">Furniture & Notes (الأثاث والملاحظات)</h3>
                            <div class="space-y-3">
                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Furniture (الأثاث)</p>
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Notes (ملاحظات)</p>
                        ...
                        @if ($hasUtilities)
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-semibold mb-4">Utility Services (خدمات المرافق)</h3>
                        ...
                        @if ($apartment->images->count() > 0)
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-semibold mb-4">Images (الصور)</h3>
