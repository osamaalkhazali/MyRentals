            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Edit Apartment #{{ $apartment->display_name }} (تعديل الشقة)</h2>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    @if ($apartment->images->count() > 0)
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium mb-2">Current Images (الصور الحالية)</label>
                                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                @foreach ($apartment->images as $image)
                                                    <div class="relative">
                                                        ...
                                                        @if ($image->is_primary)
                                                            <span
                                                                class="absolute top-2 left-2 bg-green-600 text-white text-xs px-2 py-0.5 rounded-full">Primary (رئيسية)</span>
                                                        @endif
                                                    </div>
                                                @endforeach
                                            </div>
