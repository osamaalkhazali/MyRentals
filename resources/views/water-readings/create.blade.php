            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Add New Water Reading</h2>
                    ...
                    <form action="{{ route('water-readings.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <select name="water_service_id" id="water_service_id" required
                                    ...
                                    @foreach ($waterServices as $service)
                                        <option value="{{ $service->id }}"
                                            {{ old('water_service_id', $selectedServiceId) == $service->id ? 'selected' : '' }}>
