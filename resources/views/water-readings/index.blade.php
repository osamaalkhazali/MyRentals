            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Water Readings</h2>
                                ...
                                @forelse($waterReadings as $reading)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            {{ $reading->waterService->apartment->display_name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form action="{{ route('water-readings.destroy', $reading) }}" method="POST"
                                                class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7"
                                            ...
                                            No water readings found. <a href="{{ route('water-readings.create') }}"
