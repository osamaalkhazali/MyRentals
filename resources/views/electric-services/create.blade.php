            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-semibold">Add New Electric Service (إضافة خدمة كهرباء جديدة)</h2>
                    ...
                    <form action="{{ route('electric-services.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mt-6 flex justify-end gap-4">
                            ...
                            <button type="submit"
                                ...
                                Save Electric Service (حفظ خدمة الكهرباء)
                            </button>
                        </div>
                    </form>
                </div>
